...
def _plot_one_visu_dir(visu_dir: Path,
    ...
    if out is None:
        ...
        if udotgradu:
            out = fig_dir / "Ek_{}_Ra{}_{}_{}_udotgradu.png".format(Ek, Ra, run_dir.name, tag)
        else:
            out = fig_dir / "Ek_{}_Ra{}_{}_{}_snapshots.png".format(Ek, Ra, run_dir.name, tag)
    else:
        out = out.resolve()
...
def main():
    ...
    for t in chosen_tags:
        ...
        out = fig_dir / "Ek_{}_Ra{}_{}_{}_snapshots.png".format(Ek, Ra, run_dir.name, t)
